      ...
      <div className="grid place-items-center h-[100vh] text-primary">
        <div className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl xl:text-9xl text-center font-bold text-nowrap">
          ...
          <div className="grid place-items-center grid-rows-1">
            <a href="https://github.com/securesvet">
              <FaGithubAlt className="hover:opacity-85 hover:cursor-pointer" />
            </a>
          </div>
        </div>
      </div>
      <section id="projects" className="min-w-full">
        <div className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl xl:text-9xl text-primary font-bold text-center">
          <h1 className="mb-10">
            Projects of mine
          </h1>
