...
const CssGrid = () => {
  ...
  const boxStyle =
    "border-2 border-neutral-500 rounded-xl p-0 flex flex-col items-center justify-center";
      ...
      {projectData.map((item, i) => (
        <div
          ...
          className={twMerge(
            ...
            `${i === 3 ? "md:col-span-2" : ""} ${
              i === 2 ? "md:row-span-2" : ""
            } ${i === 4 ? "md:col-span-3" : ""} relative`,
          )}
        >
          <BackgroundImage
            imageUrl={`${item.bgImage ? `/images/${item.bgImage}` : ""}`}
          />
