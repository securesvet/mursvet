...
const ProjectCard = ({
  ...
  return (
    <a href={link}>
      <div
        className={`bg-[#242424] rounded-2xl ${
          isDeveloping
            ? ("hover:bg-[#222] hover:border-[#333]")
            : ("hover:bg-[#333] hover:border-[#444]")
      ...
      >
        <div className="rounded-[inherit]">
          <div className="bg-gradient-to-t from-black to-transparent rounded-[inherit] w-full h-[50%] top-1/2 absolute">
          </div>
        ...
        <div className="absolute text-3xl top-[70%] left-[2%]">
          {isDeveloping && (
            <p className="text-base text-[#aaa] absolute -top-[20%]">
              Under development...
            </p>
          )}
        ...
        <div
          ...
          style={{ top: `${100 - percentageOnShow}%` }}
        >
        </div>
      </div>
    </a>
