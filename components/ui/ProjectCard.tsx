        ...
        <a href={link}>
            <div
                className={`w-[20rem] h-[20rem] bg-[#242424] rounded-2xl ${(isDeveloping) ? ('hover:bg-[#222] hover:border-[#333]') : ('hover:bg-[#333] hover:border-[#444]')} cursor-pointer transition-[background]
                                        border-[1px] border-[#343434] hover:opacity-85 relative ${(cardIsVisible) ? ('transition-all translate-y-0 opacity-100') : ('opacity-0 transform translate-y-[20px]')}`}>
                ...
                <div ref={myRef} className="absolute top-[100px]"></div>
            </div>
        </a>
    );
};
